...
<div id="content">
    <div class="home-intro">
        <div class="container">
            ...
            <div class="one-fourth">
                <a href="http://www.dayrui.com/free/" class="button grey huge round">查看详情</a>
            </div>
        </div>
    </div>
    <div class="container">
        <div class="one-third">
            <div class="feature-block"><!-- features blocks starts -->
                ...
                <p>FineCMS企业网站管理系统将永久真正的免费并彻底的开放所有源代码，所有功能免费开放。</p>
            </div>
        </div>
        <div class="one-third">
            <div class="feature-block">
                ...
                <p>FineCMS企业网站管理系统作为公益产品，无版权限制，无论是个人或企业都可以修改版权。 </p>
            </div>
        </div>
        <div class="one-third">
            <div class="feature-block">
    ...
    <div class="one-half">
        <div class=" myrow">
            ...
            <ul>
                <?php $return = $this->_listdata("catid=$c[catid] num=5 cache=36000"); extract($return); $count=count($result); if (is_array($result)) { foreach ($result as $key=>$t) { ?>
        ...
        <div class="container">
            ...
            <div class="flexslider clients-slider "><!-- flex slider starts -->
                <ul class="slides client-block">
                    <li>
                        <?php $return = $this->_listdata("table=link.link order=listorder_asc cache=36000"); extract($return); $count=count($result); if (is_array($result)) { foreach ($result as $key=>$t) { ?><!--循环输出友情链接数据，list教程有详细介绍-->
                        <div class="one-fifth">
